...
| 券商 / 机构 | 支持材料 | 可解析内容 | 备注 |
| --- | --- | --- | --- |
| 富途 | “年度报表”Excel（`.xlsx` / `.xls`） | 交易流水、做空开平仓、分红、期末持仓 | 富途目前只接受年度报表；利息表、成交明细、资产流水等单独文件会提示删除后重新解析。 |
| 长桥 | PDF 月结单 | 股票交易、现金分红与预扣税、证券转入/转出、期末持仓、待补成本 | 加密 PDF 需填写密码；支持上传跨月材料补齐历史成本。 |
